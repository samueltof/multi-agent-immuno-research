...
mcp = FastMCP("drugbank-mcp", working_dir="/Users/samueltorres/Documents/Repos/apps/langmanus/src/service/mcps")

# Constants
API_BASE_URL = "https://api.drugbank.com/v1"
TOOL_NAME = "drugbank-mcp"
API_KEY = os.getenv("DRUGBANK_API_KEY", "")  # Get API key from environment variable
...
async def make_api_request(endpoint: str, params: dict = None) -> Any:
    ...
    if not API_KEY:
        return {"error": "DrugBank API key not configured. Please set DRUGBANK_API_KEY environment variable."}
